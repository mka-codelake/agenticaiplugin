...
The following is the complete CLAUDE.md template content embedded in this command.
...
1. Use the embedded CLAUDE.md template content from the beginning of this command
...
2. **Read both files:**
   ...
   - Use the embedded CLAUDE.md template content from the beginning of this command (template version)
...
**Template Content:**
- The CLAUDE.md template is embedded at the beginning of this command
