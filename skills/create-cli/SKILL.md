...
```
/agenticaiplugin:create-cli [<command-name-or-description>]
```

| Mode | Command | Description |
|------|---------|-------------|
| **Interactive** (Default) | `/agenticaiplugin:create-cli` | Asks clarifying questions, then designs CLI spec |
| **With Context** | `/agenticaiplugin:create-cli inventory management CLI` | Uses description as starting point |
...
2. **No argument** → Proceed with interactive clarification (ask command name + purpose).
3. **Free-text argument** → Use as command name or description, then proceed with clarification.
